...
async function openCallingHistory(devoteeId, devoteeName) {
  ...
  try {
    ...
    const isOwnTeam    = (AppState.userRole === 'deptCoordinator' || AppState.userRole === 'teamAdmin') && d?.team_name === AppState.userTeam;
...
// deptCoordinator: sees only their own team's facilitators
